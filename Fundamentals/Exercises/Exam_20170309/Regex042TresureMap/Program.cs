        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                if (matches.Count > 0)
                {
                    ...
                    {
                        MatchCollection nameMatches = Regex.Matches(matches[j].ToString(), namePattern);
                        MatchCollection numbersMatches = Regex.Matches(matches[j].ToString(), numberPattern);
